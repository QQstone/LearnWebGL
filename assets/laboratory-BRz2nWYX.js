var v=Object.defineProperty;var C=(r,e,n)=>e in r?v(r,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[e]=n;var p=(r,e,n)=>C(r,typeof e!="symbol"?e+"":e,n);import{r as f,j as E}from"./index-eDTncNwH.js";import{b}from"./three.module-CxX1q5Pt.js";const x=(r,e,n)=>{for(let u=0;u<n;u+=1){const l=e[u],d=e[u+1];if(r>=l[0]&&r<=d[0]){const s=d[0]-l[0],g=(d[1]-l[1])/s,o=l[1]-l[0]*g;return g*r+o}}return e[n][1]};class A{constructor(e){p(this,"target");p(this,"start");p(this,"timelen");p(this,"loop");p(this,"keyFrameMap");this.target=e,this.start=0,this.timelen=5,this.loop=!1,this.keyFrameMap=new Map}update(e){const{keyFrameMap:n,start:u,timelen:l,target:d,loop:s}=this;let h=e-u;s&&(h%=l),Array.from(n.entries()).forEach(([g,o])=>{const t=o.length-1;h<o[0][0]?d[g]=o[0][1]:h>o[t][0]?d[g]=o[t][1]:d[g]=x(h,o,t)})}}class M{constructor(){p(this,"children");this.children=[]}add(e){this.children.push(e)}update(e){this.children.forEach(n=>{n.update(e)})}}function k(){const r=f.useRef(null),e=f.useRef(new M),n=f.useRef(),u=f.useRef([]),[l,d]=f.useState([]),[s,h]=f.useState();f.useEffect(()=>{u.current=l},[l]),f.useEffect(()=>{const o=r.current;if(!o||s)return;o.width=window.innerWidth,o.height=window.innerHeight;const t=o.getContext("webgl");if(!t)return;const w=`
